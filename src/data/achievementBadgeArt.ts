...
const BADGE_CATALOG: Record<string, Omit<AchievementBadgeArt, 'category'> & { category?: MissionCategory }> = {
  ...
  primer_consumo_libre: { shape: 'hex', glyph: '🧾', difficulty: 'easy' },
  primer_gasto_minimo: { shape: 'diamond', glyph: '💳', difficulty: 'medium' },
  primera_carta_productos: { shape: 'hex', glyph: '🍽️', difficulty: 'medium' },
  ruta_de_bar: { shape: 'circle', glyph: '🍻', difficulty: 'medium' },
  ruta_de_restaurante: { shape: 'shield', glyph: '🍴', difficulty: 'medium' },
  consumidor_habitual: { shape: 'hex', glyph: '🧾', difficulty: 'medium' },
  cazador_minimos: { shape: 'star', glyph: '💳', difficulty: 'medium' },
  ...
  primera_mesa: { shape: 'shield', glyph: '🎉', difficulty: 'easy' },
  diez_servicios: { shape: 'hex', glyph: '🔟', difficulty: 'easy' },
  cincuenta_mesas: { shape: 'circle', glyph: '🏅', difficulty: 'medium' },
  cien_reservas: { shape: 'star', glyph: '💯', difficulty: 'hard' },
  doscientas_mesas: { shape: 'shield', glyph: '🏛️', difficulty: 'hard' },
  veterano_adelia: { shape: 'diamond', glyph: '👑', difficulty: 'legendary' },
  diez_opiniones: { shape: 'hex', glyph: '🗣️', difficulty: 'medium' },
  cincuenta_voces: { shape: 'star', glyph: '📣', difficulty: 'hard' },
  anfitrion_responde: { shape: 'circle', glyph: '💌', difficulty: 'medium' },
  maestro_respuesta: { shape: 'shield', glyph: '🎩', difficulty: 'hard' },
  media_cuatro: { shape: 'star', glyph: '⭐', difficulty: 'medium' },
  media_brillante: { shape: 'diamond', glyph: '🌟', difficulty: 'hard' },
  adelinas_100: { shape: 'circle', glyph: '🪙', difficulty: 'medium' },
  adelinas_500: { shape: 'hex', glyph: '💰', difficulty: 'hard' },
  foto_casa: { shape: 'hex', glyph: '📸', difficulty: 'medium' },
  grupo_festejo: { shape: 'star', glyph: '🎊', difficulty: 'medium' },
  casa_del_barrio: { shape: 'shield', glyph: '🏡', difficulty: 'medium' },
  casa_ilustre: { shape: 'diamond', glyph: '🏰', difficulty: 'hard' },
  emblema_fogon: { shape: 'diamond', glyph: '💠', difficulty: 'legendary' },
}
